...
// Semua enkripsi harus lewat backend
export function aesEncrypt() {
  throw new Error('Use backend API for AES encryption');
}

// Semua dekripsi harus lewat backend
export function aesDecrypt() {
  throw new Error('Use backend API for AES decryption');
}
